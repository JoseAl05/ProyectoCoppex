import { InjectionToken, EventEmitter, Component, forwardRef, Inject, Input, ViewChild, Output, Pipe, NgModule } from '@angular/core';
...
function MatSelectCountryComponent_mat_label_1_Template(rf, ctx) { if (rf & 1) {
...
function MatSelectCountryComponent_mat_icon_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "mat-icon", 8);
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("svgIcon", ctx_r1.value == null ? null : ctx_r1.value.alpha2Code == null ? null : ctx_r1.value.alpha2Code.toLowerCase());
} }
function MatSelectCountryComponent_mat_progress_bar_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "mat-progress-bar", 9);
} }
...
function MatSelectCountryComponent_mat_option_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtext(3);
    ɵngcc0.ɵɵpipe(4, "joinStrings");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const country_r5 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("value", country_r5 == null ? null : country_r5.name);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("svgIcon", country_r5 == null ? null : country_r5.alpha2Code == null ? null : country_r5.alpha2Code.toLowerCase());
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ɵngcc0.ɵɵpipeBind1(4, 3, ɵngcc0.ɵɵpureFunction2(5, _c1, country_r5 == null ? null : country_r5.name, country_r5 == null ? null : country_r5.alpha3Code)));
} }
...
class MatSelectCountryComponent {
    ...
    _importLang(i18n) {
        switch (i18n) {
            case 'de':
                return Promise.resolve().then(function () { return de; }).then(result => result.COUNTRIES_DB_DE).then(y => {
                    this.countries = y;
                    return y;
                });
            case 'it':
                return Promise.resolve().then(function () { return it; }).then(result => result.COUNTRIES_DB_IT).then(y => {
                    this.countries = y;
                    return y;
                });
            case 'es':
                return Promise.resolve().then(function () { return es; }).then(result => result.COUNTRIES_DB_ES).then(y => {
                    this.countries = y;
                    return y;
                });
            case 'fr':
                return Promise.resolve().then(function () { return fr; }).then(result => result.COUNTRIES_DB_FR).then(y => {
                    this.countries = y;
                    return y;
                });
            default:
                // console.log('running with default');
                return Promise.resolve().then(function () { return en; }).then(result => result.COUNTRIES_DB).then(y => {
                    this.countries = y;
                    return y;
                });
        }
...
MatSelectCountryComponent.ɵfac = function MatSelectCountryComponent_Factory(t) { return new (t || MatSelectCountryComponent)(ɵngcc0.ɵɵdirectiveInject(forwardRef(() => MatSelectCountryLangToken))); };
MatSelectCountryComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatSelectCountryComponent, selectors: [["mat-select-country"]], viewQuery: function MatSelectCountryComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true);
        ɵngcc0.ɵɵviewQuery(MatAutocompleteTrigger, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.statesAutocompleteRef = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.autocompleteTrigger = _t.first);
    } }, inputs: { placeHolder: "placeHolder", value: "value", disabled: "disabled", countries: "countries", appearance: "appearance", label: "label", required: "required", nullable: "nullable", readonly: "readonly", class: "class", itemsLoadSize: "itemsLoadSize", loading: "loading" }, outputs: { onCountrySelected: "onCountrySelected" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => MatSelectCountryComponent),
                multi: true
            },
        ]), ɵngcc0.ɵɵNgOnChangesFeature], decls: 8, vars: 13, consts: [[3, "appearance"], [4, "ngIf"], ["class", "mr-12 s-20 secondary-text", "matSuffix", "", 3, "svgIcon", 4, "ngIf"], ["aria-label", "country", "matInput", "", "type", "text", 3, "matAutocomplete", "placeholder", "readonly", "value", "required", "disabled", "blur", "input"], ["mode", "buffer", 4, "ngIf"], [3, "opened", "optionSelected"], ["countryAutocomplete", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], ["matSuffix", "", 1, "mr-12", "s-20", "secondary-text", 3, "svgIcon"], ["mode", "buffer"], [3, "value"], [3, "svgIcon"]], template: function MatSelectCountryComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "mat-form-field", 0);
        ɵngcc0.ɵɵtemplate(1, MatSelectCountryComponent_mat_label_1_Template, 2, 1, "mat-label", 1);
        ɵngcc0.ɵɵtemplate(2, MatSelectCountryComponent_mat_icon_2_Template, 1, 1, "mat-icon", 2);
        ɵngcc0.ɵɵelementStart(3, "input", 3);
        ɵngcc0.ɵɵlistener("blur", function MatSelectCountryComponent_Template_input_blur_3_listener() { return ctx.onBlur(); })("input", function MatSelectCountryComponent_Template_input_input_3_listener($event) { return ctx.inputChanged($event == null ? null : $event.target == null ? null : $event.target.value); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtemplate(4, MatSelectCountryComponent_mat_progress_bar_4_Template, 1, 0, "mat-progress-bar", 4);
        ɵngcc0.ɵɵelementStart(5, "mat-autocomplete", 5, 6);
        ɵngcc0.ɵɵlistener("opened", function MatSelectCountryComponent_Template_mat_autocomplete_opened_5_listener() { return ctx.autocompleteScroll(); })("optionSelected", function MatSelectCountryComponent_Template_mat_autocomplete_optionSelected_5_listener($event) { return ctx.onOptionsSelected($event); });
        ɵngcc0.ɵɵtemplate(7, MatSelectCountryComponent_mat_option_7_Template, 5, 8, "mat-option", 7);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ...
        ɵngcc0.ɵɵproperty("matAutocomplete", _r3)("placeholder", ctx.placeHolder)("readonly", ctx.readonly)("value", ctx.value == null ? null : ctx.value.name)("required", ctx.required)("disabled", ctx.disabled || ctx.loadingDB);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx.loadingDB || ctx.loading);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("ngForOf", ctx.filteredOptions);
    } }, directives: function () { return [ɵngcc1.MatFormField, ɵngcc2.NgIf, ɵngcc3.MatInput, ɵngcc4.MatAutocompleteTrigger, ɵngcc4.MatAutocomplete, ɵngcc2.NgForOf, ɵngcc1.MatLabel, ɵngcc5.MatIcon, ɵngcc1.MatSuffix, ɵngcc6.MatProgressBar, ɵngcc7.MatOption]; }, pipes: function () { return [JoinStringsPipe]; }, styles: [""] });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MatSelectCountryComponent, [{
        type: Component,
        args: [{
...
JoinStringsPipe.ɵfac = function JoinStringsPipe_Factory(t) { return new (t || JoinStringsPipe)(); };
JoinStringsPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "joinStrings", type: JoinStringsPipe, pure: true });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(JoinStringsPipe, [{
        type: Pipe,
...
MatSelectCountryModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: MatSelectCountryModule });
MatSelectCountryModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MatSelectCountryModule_Factory(t) { return new (t || MatSelectCountryModule)(ɵngcc0.ɵɵinject(ɵngcc5.MatIconRegistry), ɵngcc0.ɵɵinject(ɵngcc8.DomSanitizer)); }, imports: [[
            CommonModule,
            // Forms
            FormsModule,
            ReactiveFormsModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MatSelectCountryModule, { declarations: function () { return [MatSelectCountryComponent, JoinStringsPipe]; }, imports: function () { return [CommonModule,
        // Forms
        FormsModule,
        ReactiveFormsModule,
        // Material
        ...
        MatAutocompleteModule,
        MatIconModule,
        MatProgressBarModule]; }, exports: function () { return [MatSelectCountryComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MatSelectCountryModule, [{
        type: NgModule,
        args: [{
                declarations: [
    ...
    }], function () { return [{ type: ɵngcc5.MatIconRegistry }, { type: ɵngcc8.DomSanitizer }]; }, null); })();
...
export { COUNTRIES_DB, COUNTRIES_DB_DE, COUNTRIES_DB_ES, COUNTRIES_DB_FR, COUNTRIES_DB_IT, MatSelectCountryComponent, MatSelectCountryLangToken, MatSelectCountryModule, JoinStringsPipe as ɵa };
